...
IMGUI_API bool ImGui::Selectable(std::string_view label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
...
bool ImGui::sub(const char* label, bool selected)
{
    ...
    if (selected) {
        window->DrawList->AddRectFilled(bb.Min, bb.Max, ImColor(0, 0, 0, 0));
        window->DrawList->AddRectFilled(ImVec2(bb.Min.x, bb.Max.y - 3), ImVec2(bb.Max.x, bb.Max.y), ImColor(127, 86, 202, 255));
    }
